...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Soft tissue procedures", href: "/services#soft-tissue-procedures", description: "Selected soft tissue surgical services." },
      { label: "Orthopaedic procedures", href: "/services#orthopaedic-procedures", description: "Orthopaedic services assessed case by case." },
      { label: "Endoscopy and sensitive care", href: "/services#endoscopy-and-sensitive-care", description: "Endoscopy, aftercare, and careful conversations." },
